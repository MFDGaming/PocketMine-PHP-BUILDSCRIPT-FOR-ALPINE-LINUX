apk update
apk add make autoconf automake libtool m4 wget musl-utils gzip bzip2 bison g++ git cmake pkgconfig libressl-dev openssl libzip-dev curl-dev readline-dev yaml-dev libpng-dev gmp-dev oniguruma bash --repository=http://dl-cdn.alpinelinux.org/alpine/edge/main
